...
# test 1 date, "ASIS"
vvv = get.wrf.tvar("hgt", subset = c("1981-01-01 00:00:00", "1981-01-01 23:00:00"), path = "/nfs/gpfs/PAS0661/downscaling2/wrf/2016-08-26/wrfout/", pattern = "wrfout_d01_1981-01-01 *", calc = "ASIS", prlevs = 500, offset = NULL, return_tstamp = TRUE)

# test multiple dates, "ASIS"
vvv = get.wrf.tvar("hgt", subset = c("1981-02-28 00:00:00", "1981-03-01 23:00:00"), path = "/nfs/gpfs/PAS0661/downscaling2/wrf/2016-08-26/wrfout/", pattern = "wrfout_d01_1981-0[23]-0*", calc = "ASIS", prlevs = 500, offset = NULL, return_tstamp = TRUE)
